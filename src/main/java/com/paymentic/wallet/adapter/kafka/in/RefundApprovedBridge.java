...
public class RefundApprovedBridge {
  private static final String REFUND_APPROVED_EVENT_TYPE = "funny-bunny.xyz.payment-processing.v1.refund.approved";
  ...
  @KafkaListener(id = "refundOrderApproved",groupId = "wallet-group-id", topics = "${consumers.payment-processing-topic}")
